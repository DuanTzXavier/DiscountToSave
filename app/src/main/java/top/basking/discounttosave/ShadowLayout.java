...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mShadowColor = attr.getColor(R.styleable.ShadowLayout_sl_shadowColor, getResources().getColor(R.color.colorAccents));
        } finally {
            attr.recycle();
        }
    }
...
//        shadowPaint.setStyle();
        mShadowColor = Color.argb(128, 249, 94, 94);

        if (!isInEditMode()) {
            shadowPaint.setShadowLayer(shadowRadius, dx, dy, mShadowColor);
        }
